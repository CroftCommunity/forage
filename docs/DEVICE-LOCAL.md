...
| `forage.feedindex` | localStorage | the reader's own discovery index and the mode (Add / Replace / Off) — plan 2026-09-08 feed-index Phase 2b | `planned` | `plans/2026-09-21-plan-own-index-on-the-pds.md` (DRAFT 2026-09-21, owner review) — shape DECIDED 2026-09-14 (see above): local default; whole-file record or pointer record on the account; Forage's index always available, never retakes the default |
