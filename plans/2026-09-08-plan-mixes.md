...
weight is — see *Decisions* and the Review Log). D6 is final once the cellular timing in the
device queue (the tagged bullet at the end of the Review Log) has run. D4's second half — mixes as a PDS record — is
