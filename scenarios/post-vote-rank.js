...
// Covers: post.created, post.edited, vote.set (+ registrations, field).
...
export const postVoteRank = {
  ...
  events: [
    ...
    { t: 0, actor: 'u_sage', type: 'field.created', payload: { id: 'f_meadow', slug: 'meadow', title: 'Meadow' } },
    { t: 5, actor: 'u_fern', type: 'field.joined', payload: { fieldId: 'f_meadow' } },
    { t: 6, actor: 'u_alder', type: 'field.joined', payload: { fieldId: 'f_meadow' } },
    { t: 100, actor: 'u_fern', type: 'post.created', payload: { id: 'p_a', fieldId: 'f_meadow', format: 'text', title: 'First sowing' } },
    { t: 200, actor: 'u_alder', type: 'post.created', payload: { id: 'p_b', fieldId: 'f_meadow', format: 'text', title: 'Bed rotation' } },
    { t: 300, actor: 'u_fern', type: 'post.created', payload: { id: 'p_c', fieldId: 'f_meadow', format: 'text', title: 'Mulch question' } },
  ...
  assertions: [
    ...
    { seat: null, probe: 'feedIds', args: { scope: 'field:meadow', sort: 'top' }, expect: ['p_a', 'p_c', 'p_b'] },
    { seat: null, probe: 'feedIds', args: { scope: 'field:meadow', sort: 'new' }, expect: ['p_c', 'p_b', 'p_a'] },
