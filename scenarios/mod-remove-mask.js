...
export const modRemoveMask = {
  ...
  events: [
    ...
    { t: 0, actor: 'u_sage', type: 'field.created', payload: { id: 'f_hedge', slug: 'hedge', title: 'Hedge' } },
    { t: 1, actor: 'u_sage', type: 'mod.stewardAdded', payload: { fieldId: 'f_hedge', userId: 'u_briar' } },
    { t: 5, actor: 'u_fern', type: 'field.joined', payload: { fieldId: 'f_hedge' } },
    { t: 6, actor: 'u_dell', type: 'field.joined', payload: { fieldId: 'f_hedge' } },
    { t: 10, actor: 'u_fern', type: 'post.created', payload: { id: 'p_spam', fieldId: 'f_hedge', format: 'text', title: 'Discount seeds!!!' } },
    { t: 20, actor: 'u_fern', type: 'post.created', payload: { id: 'p_held', fieldId: 'f_hedge', format: 'text', title: 'Held by automod', held: true } },
    { t: 30, actor: 'u_fern', type: 'post.created', payload: { id: 'p_plain', fieldId: 'f_hedge', format: 'text', title: 'Plain post' } },
    { t: 40, actor: 'u_fern', type: 'post.created', payload: { id: 'p_notice', fieldId: 'f_hedge', format: 'text', title: 'Field notice' } },
    { t: 50, actor: 'u_fern', type: 'report.filed', payload: { id: 'r_spam', subjectType: 'post', subjectId: 'p_spam', fieldId: 'f_hedge', reason: 'spam' } },
  ...
  assertions: [
    ...
    { seat: 'u_fern', probe: 'feedIds', args: { scope: 'field:hedge', sort: 'new' }, expect: ['p_notice', 'p_plain', 'p_held'] },
    // stewards additionally see the removed post (oldest, so last under 'new')
    { seat: 'u_briar', probe: 'feedIds', args: { scope: 'field:hedge', sort: 'new' }, expect: ['p_notice', 'p_plain', 'p_held', 'p_spam'] },
