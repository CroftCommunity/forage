...
// discounted reports, and no Field creation; prefs updates merge.
...
export const rateLimitProbation = {
  ...
  description: 'A 3-day-old account is on probation: doubled cooldowns bind, field creation gated, report weight discounted; prefs merge.',
  events: [
    ...
    { t: 0, actor: 'u_sage', type: 'field.created', payload: { id: 'f_patch', slug: 'patch', title: 'Patch' } },
    { t: 5, actor: 'u_newt', type: 'field.joined', payload: { fieldId: 'f_patch' } },
    { t: 10, actor: 'u_newt', type: 'prefs.updated', payload: { patch: { defaultSort: 'new' } } },
    { t: 20, actor: 'u_sage', type: 'post.created', payload: { id: 'p_intro', fieldId: 'f_patch', format: 'text', title: 'Introductions' } },
  ...
  assertions: [
    { seat: 'u_newt', probe: 'perm', args: { fieldId: 'f_patch', key: 'probation' }, expect: true },
    { seat: 'u_newt', probe: 'perm', args: { fieldId: 'f_patch', key: 'canCreateField' }, expect: false },
    { seat: 'u_newt', probe: 'perm', args: { fieldId: 'f_patch', key: 'reportWeight' }, expect: 0.3 },
    { seat: 'u_newt', probe: 'perm', args: { fieldId: 'f_patch', key: 'canPost' }, expect: true }, // probation ≠ banned
