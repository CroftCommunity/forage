...
export const reportResolveNotify = {
  ...
  events: [
    ...
    { t: 0, actor: 'u_sage', type: 'feed.created', payload: { id: 'f_gate', slug: 'gate', title: 'Gate' } },
    { t: 1, actor: 'u_sage', type: 'mod.stewardAdded', payload: { feedId: 'f_gate', userId: 'u_briar' } },
    { t: 10, actor: 'u_fern', type: 'post.created', payload: { id: 'p_q', feedId: 'f_gate', format: 'text', title: 'Question' } },
    ...
    { t: 30, actor: 'u_fern', type: 'report.filed', payload: { id: 'r_sus', subjectType: 'comment', subjectId: 'c_sus', feedId: 'f_gate', reason: 'misleading' } },
