...
const SHELL = [
  ...
  '/js/version.js', '/js/mode.js', '/js/board-cache.js', '/js/scroll-memory.js', '/js/hero.js', '/js/card-size.js', '/js/pictures.js', '/js/gif.js', '/js/gif-autoplay.js', '/js/alt-text.js', '/js/thread-shape.js', '/js/self-thread-view.js', '/js/rail.js', '/js/provider-mark.js', '/js/drafts.js', '/js/ui/stage.js', '/js/lang.js', '/js/compose.js', '/js/ui/mode-view.js', '/css/tokens.css', '/css/app.css',
  ...
  '/js/board-density.js', '/js/last-board.js', '/js/share-target.js', '/js/rings.js', '/js/ring-scope.js', '/js/tagsubs.js', '/js/tagsubs-pds.js', '/js/lexicon.js', '/js/lexicons.js', '/js/tag-stats.js', '/js/trending-tags.js', '/js/hashtag-prefs.js', '/js/prng.js', '/js/devbar.js', '/js/engines/rank.js',
