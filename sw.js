...
const CACHE = 'forage-v28';
const SHELL = [
  '/', '/404.html', '/skins/bbs.css', '/skins/usenet.css', '/skins/forage-dark.css', '/skins/phpbb.css', '/skins/phpbb-dark.css',
  ...
  '/js/prng.js', '/js/devbar.js', '/js/engines/rank.js',
