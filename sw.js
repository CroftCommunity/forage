...
const SHELL = [
  ...
  '/js/board-density.js', '/js/last-board.js', '/js/rings.js', '/js/tagsubs.js', '/js/tag-stats.js', '/js/trending-tags.js', '/js/hashtag-prefs.js', '/js/prng.js', '/js/devbar.js', '/js/engines/rank.js',
